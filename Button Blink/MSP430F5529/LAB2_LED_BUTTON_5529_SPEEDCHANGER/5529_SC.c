/*
 *  SIMPLE BUTTON PRESS 5529 w/ Speedchange
 *
...
{
    __delay_cycles(100000)//Delaying logic so that the button settles
    switch(x) //Logic switch control for button speed change
    {
    case(0):
        TA0CCR0 = 10000;
        x++;
